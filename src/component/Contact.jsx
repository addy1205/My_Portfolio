                ...
                <div className='bg-[#c5ba22] text-black px-[5%] lg:px-[8%] pt-[50px]'>
                    <div className='flex flex-col gap-[50px] sm:flex-row sm:gap-[8%] md:gap-[15%] mbTb:justify-between'>
                        <div className='text-left w-[90%] sm:w-[40%]'>
                            ...
                            <div>
                                <a href='https://www.linkedin.com/in/adnan-azad-aa65612b5/' target='_blank' className='aboutSocialIconsDiv bg-blue-500 rounded-full inline-block p-2 w-10 mr-4'>
                                    <img className="aboutSocialIcons w-8" src={linkedinIcon} alt="linkedin" />
                                </a>
                                <a href='https://github.com/addy1205' target='_blank' className='aboutSocialIconsDiv bg-blue-500 rounded-full inline-block p-2 w-10 mr-4'>
                                    <img className="aboutSocialIcons w-8" src={githubIcon} alt="github" />
                                </a>
                                <a href='mailto:azadadnan113@gmail.com' target='_blank' className='aboutSocialIconsDiv bg-blue-500 rounded-full inline-block p-2 w-10 mr-4'>
                                    <img className="aboutSocialIcons w-8" src={mailIcon} alt="github" />
                                </a>
                                <a href='https://www.instagram.com/addy.1205/' target='_blank' className='aboutSocialIconsDiv bg-blue-500 rounded-full inline-block p-2 w-10 mr-4'>
                    ...
                    <div className='mt-8 pb-3'>
                        ...
                        <p>Designed by  <span className='font-bold'>&#123; <span className='text-[blue]'>Adnan</span> &#125;</span></p>
                    </div>
                </div>
