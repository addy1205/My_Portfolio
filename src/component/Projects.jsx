...
import portfolioImg from "../assets/Portfolio_My.png"
import countryPage from "../assets/country.png"
...
const projectsArray = [
    {
        ...
        image: countryPage,
        name: "CountriesApp",
        description: "Designed and developed a responsive web application using React.js and the REST Countries API. Implemented features such as dynamic country search, regional filtering, detailed country insights, theme toggling, and mobile-first responsive design.",
        techStack: ["React JS", "Rest API"],
        link: "https://countries-api-prods.netlify.app",
        target: "_blank",
        github: "https://github.com/addy1205/CountriesAPI"
    ...
    },
    {
        ...
        target: "",
        github: "https://github.com/addy1205/Online_Voting_System"
    ...
    },
    {
        ...
        link: "#About",
        target: "",
        github: "https://github.com/addy1205/My_Portfolio"
