            ...
            <div className='tracking-widest w-[100%] mx-auto flex py-4 pl-[8%] pr-[8%]'>
                <div className='flex flex-col items-center mbTb:items-top mbTb:flex-row mbTb:gap-[5%] xl:gap-[15%]'>
                    <div className=' mbTb:w-[50%] pt-[50px] pr-[12%]'>
                        ...
                        <h1 className='text-5xl font-bold py-2'>Md Adnan Azad</h1>
                ...
                <div className='flex flex-col items-center gap-6 mt-6 fixed right-4 mbTb:right-7'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <a href='https://www.linkedin.com/in/adnan-azad-aa65612b5/' target='_blank' className='aboutSocialIconsDiv bg-[#c5ba22] rounded-full inline-block p-2 w-10'>
                            <img className="aboutSocialIcons w-8" src={linkedinIcon} alt="linkedin" />
                        </a>
                        <a href='https://github.com/addy1205' target='_blank' className='aboutSocialIconsDiv bg-[#c5ba22] rounded-full inline-block p-2 w-10'>
